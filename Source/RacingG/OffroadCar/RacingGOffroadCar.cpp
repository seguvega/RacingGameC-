...
#include "RacingGOffroadCar.h"
#include "RacingGOffroadWheelFront.h"
#include "RacingGOffroadWheelRear.h"
...
ARacingGOffroadCar::ARacingGOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingGOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingGOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingGOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingGOffroadWheelRear::StaticClass();
