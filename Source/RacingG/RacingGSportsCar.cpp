...
#include "RacingGSportsCar.h"
#include "RacingGSportsWheelFront.h"
#include "RacingGSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ARacingGSportsCar::ARacingGSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = URacingGSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = URacingGSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = URacingGSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = URacingGSportsWheelRear::StaticClass();
